...
function SvgAst(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_Svg.default, _extends({}, props, override), children);
}
...
function SvgXml(props) {
  ...
  try {
    return /*#__PURE__*/_react.default.createElement(SvgAst, {
      ast: ast,
...
function SvgUri(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(SvgXml, {
    xml: xml,
    override: props
  });
}
...
class SvgFromUri extends _react.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(SvgFromXml, {
      xml: xml,
      override: props
    });
  }
