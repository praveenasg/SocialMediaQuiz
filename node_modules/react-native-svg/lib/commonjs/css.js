    ...
    try {
      ...
      _cssTree.default.walk(rule, {
        ...
        enter(node) {
          ...
          const name = property.trim();
          const camel = (0, _xml.camelCase)(name);
...
function SvgCss(props) {
  ...
  const ast = (0, _react.useMemo)(() => xml !== null ? (0, _xml.parse)(xml, inlineStyles) : null, [xml]);
  return /*#__PURE__*/_react.default.createElement(_xml.SvgAst, {
    ast: ast,
...
function SvgCssUri(props) {
  ...
  (0, _react.useEffect)(() => {
    uri ? (0, _xml.fetchText)(uri).then(data => {
      setXml(data);
      onLoad === null || onLoad === void 0 ? void 0 : onLoad();
    }).catch(onError) : setXml(null);
  }, [onError, uri, onLoad]);
  return /*#__PURE__*/_react.default.createElement(SvgCss, {
    xml: xml,
    override: props
  });
}
...
class SvgWithCssUri extends _react.Component {
  ...
  async fetch(uri) {
    try {
      this.setState({
        xml: uri ? await (0, _xml.fetchText)(uri) : null
      });
    } catch (e) {
      this.props.onError ? this.props.onError(e) : console.error(e);
    }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(SvgWithCss, {
      xml: xml,
      override: props
    });
  }
